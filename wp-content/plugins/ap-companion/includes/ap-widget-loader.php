...
class ApWidgetLoader {
    ...
    function add_elementor_widget_categories() {
        ...
        $groups = array(
            ...
            'applx-elements'        => esc_html__( 'AccessPress Parallax', 'ap-companion' )
        );
    ...
    public function enqueue_frontend_scripts() {
        ...
        if( get_template() == 'accesspress-parallax' ){
            wp_enqueue_script( 'applx-frontend', AP_COMPANION_URL . 'assets/js/applx-frontend.js', [], AP_COMPANION_VERSION );
        }
    }
